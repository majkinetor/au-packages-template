$packageArgs = @{
  ...
  url64bit               = 'https://github.com/Daniel-Abrecht/fuse-nfs-crossbuild-scripts/releases/download/libnfs%3Dlibnfs-2.0.0_fuse-nfs%3Dbdd4e2bfede5ced1e1d1ab21c7652e9905b7f668_dokany%3Dv1.1.0/x86_64-w64-mingw32.zip'
