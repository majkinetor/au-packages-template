...
$url = 'https://download.red-gate.com/installers/SQLToolbelt/2019-11-27/SQLToolbelt.exe'
$checksum = 'F93157AAABC0D81B92F3F398333F7999500E283048AE7823AD57E1A300183A33'
