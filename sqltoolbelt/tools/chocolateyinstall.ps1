...
$url = 'https://download.red-gate.com/installers/SQLToolbelt/2020-02-20/SQLToolbelt.exe'
$checksum = '65FA7FF4927F1C0B0022CF8A06ABD4629F3B0176386C278B2CBA8276618446AE'
