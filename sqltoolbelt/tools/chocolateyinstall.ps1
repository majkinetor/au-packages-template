...
$url = 'https://download.red-gate.com/installers/SQLToolbelt/2020-05-22/SQLToolbelt.exe'
$checksum = '8C6B82492B224011226581E661DEFDA4FCD983906A5C22A42476EE83B0CAC298'
