...
$url = 'https://download.red-gate.com/installers/SQLToolbelt/2020-06-01/SQLToolbelt.exe'
$checksum = 'E2EF157A6A6305C2C642492E19FA753954C4611C860D2911449060EB83E3F2A2'
