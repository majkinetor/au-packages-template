...
$url = 'https://download.red-gate.com/installers/SQLToolbelt/2019-10-02/SQLToolbelt.exe'
$checksum = '9C3A646EDD0AE799DAE9BC49E5667167EBB17360E65AC0F069C0E56B4510481C'
