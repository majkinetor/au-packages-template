...
$url = 'https://download.red-gate.com/installers/SQLToolbelt/2020-04-28/SQLToolbelt.exe'
$checksum = '203CB46CF9EE0552CF8EEC981E050546127366728B78B0DBCC68EBED8C3D7F1D'
