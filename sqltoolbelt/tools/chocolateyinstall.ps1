...
$url = 'https://download.red-gate.com/installers/SQLToolbelt/2019-12-18/SQLToolbelt.exe'
$checksum = '6B3F6D2BC4B8A55DA04EF81C2B35F2FB3FCA0F3C23B6A1250FC97DEC8C17C2D3'
