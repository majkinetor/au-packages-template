...
$url = 'https://download.red-gate.com/installers/SQLToolbelt/2020-06-15/SQLToolbelt.exe'
$checksum = '98684AA68A800C5D359B17ABC97E74EE420F9B9F132377070B705C381F2ABD2C'
