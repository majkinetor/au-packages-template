...
$url = 'https://download.red-gate.com/installers/SQLToolbelt/2019-11-12/SQLToolbelt.exe'
$checksum = '0757A8068B2663225FEFD7EFB6904ECD1C6CBFF6B047E07AC8F4A38C019BC886'
