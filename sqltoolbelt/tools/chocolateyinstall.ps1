...
$url = 'https://download.red-gate.com/installers/SQLToolbelt/2020-08-04/SQLToolbelt.exe'
$checksum = '14D36DE4F81B4797571C5A782ADC175FF28C392D95F5B43F9C2EA6635341DB04'
