...
$url = 'https://download.red-gate.com/installers/SQLToolbelt/2020-02-27/SQLToolbelt.exe'
$checksum = 'BEE149AAFA7823DB602B13EE494DF9CCED9228EA1505A8F757FFE393FCF2FC6E'
