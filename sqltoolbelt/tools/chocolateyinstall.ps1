...
$url = 'https://download.red-gate.com/installers/SQLToolbelt/2020-07-16/SQLToolbelt.exe'
$checksum = '1E9E12EE17FDC4AB621CFD2825001BC437FC0D801757D48719DC0C72CEED94EA'
