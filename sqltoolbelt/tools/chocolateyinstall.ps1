...
$url = 'https://download.red-gate.com/installers/SQLToolbelt/2020-06-16/SQLToolbelt.exe'
$checksum = '494DE45D799593740CEA116987F67A81420337097B6F4C7B609BE20407653D4C'
