...
$url = 'https://download.red-gate.com/installers/SQLToolbelt/2020-04-27/SQLToolbelt.exe'
$checksum = '571B215DBA0EA41744053B0D30A176233C29E53826BC921B1B19011773B1988C'
