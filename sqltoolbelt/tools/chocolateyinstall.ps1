...
$url = 'https://download.red-gate.com/installers/SQLToolbelt/2020-05-21/SQLToolbelt.exe'
$checksum = '2809FCE2A793C3CB7B83110F5767AD4EDE2D7544C9F609CD7E110926F9EE4CC9'
