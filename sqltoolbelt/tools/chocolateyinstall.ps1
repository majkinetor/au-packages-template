...
$url = 'https://download.red-gate.com/installers/SQLToolbelt/2019-10-30/SQLToolbelt.exe'
$checksum = '63DF00D4DF36B7E5FAA7EA7E32BE2C91A9C87A2867C344F5A0B6623210FCB758'
