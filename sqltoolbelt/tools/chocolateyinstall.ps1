...
$url = 'https://download.red-gate.com/installers/SQLToolbelt/2020-02-26/SQLToolbelt.exe'
$checksum = '3B71C2F0C50B4753DADE1D507B17A9D4C0B6A792FB027669CE028AA87BC12012'
