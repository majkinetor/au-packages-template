...
$url = 'https://download.red-gate.com/installers/SQLToolbelt/2020-07-09/SQLToolbelt.exe'
$checksum = '171931E1BDC403898B13FB14B406BEB31B13F476D0962EDF1268691FF8CF827C'
