...
$url = 'https://download.red-gate.com/installers/SQLToolbelt/2019-10-16/SQLToolbelt.exe'
$checksum = '3603CAF2895D57E934400A8BFA818EB46CBB697BF050825147F84A8BD8CF34F4'
