...
$url = 'https://download.red-gate.com/installers/SQLToolbelt/2019-11-21/SQLToolbelt.exe'
$checksum = '2C4A83C1DEA3648D270535EA2ECF80300E0A59D9025CA75879C4B0DC1240F276'
