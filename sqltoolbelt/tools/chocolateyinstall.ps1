...
$url = 'https://download.red-gate.com/installers/SQLToolbelt/2020-02-25/SQLToolbelt.exe'
$checksum = 'E6A4D2546565C400DE696982509295B44184EB55BEEC9C21E2BA624A89DC7F7D'
