...
$url = 'https://download.red-gate.com/installers/SQLToolbelt/2020-05-05/SQLToolbelt.exe'
$checksum = '363358BA957384C0BD85CD2F448B6C731466036B9FCC588EA0495F793801407D'
