...
$url = 'https://download.red-gate.com/installers/SQLToolbelt/2019-11-13/SQLToolbelt.exe'
$checksum = '80E90B70E0DB72A3F5CCD3F1A5219B00896FF0586D9A509C31E013457403262C'
