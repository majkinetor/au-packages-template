...
$url = 'https://download.red-gate.com/installers/SQLToolbelt/2019-11-06/SQLToolbelt.exe'
$checksum = '2F1D2628077C32CE1189C0B60FD02244C187BFB1571E00C43FC272ACFDA3F34F'
