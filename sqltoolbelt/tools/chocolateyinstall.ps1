...
$url = 'https://download.red-gate.com/installers/SQLToolbelt/2020-05-12/SQLToolbelt.exe'
$checksum = 'E97B9A7B3036D9929C001F2EDD9421FDBCFA82370A52D2C14C5052843E913AD0'
