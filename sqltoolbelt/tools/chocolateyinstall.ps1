...
$url = 'https://download.red-gate.com/installers/SQLToolbelt/2020-01-23/SQLToolbelt.exe'
$checksum = 'C477470FEA9D58BFC1F5D05AFCC295042F1E0A627AC9F0D96793284EB0DE2C51'
