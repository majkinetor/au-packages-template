...
$url = 'https://download.red-gate.com/installers/SQLToolbelt/2020-06-02/SQLToolbelt.exe'
$checksum = 'BC43E0047BACF64131E1B0B089B5643CEE4901C192CB07216BB2EBFC437E2EDC'
