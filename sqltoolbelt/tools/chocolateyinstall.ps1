...
$url = 'https://download.red-gate.com/installers/SQLToolbelt/2019-12-03/SQLToolbelt.exe'
$checksum = 'C7E0F6903081CC21BB3508E0C90F33CB6E8E947CB2748341485F4B02AE0B9BAD'
