...
$url = 'https://download.red-gate.com/installers/SQLToolbelt/2020-01-30/SQLToolbelt.exe'
$checksum = 'A63B4F02AC183DB6F3211B7769FBEEE51BB1ABCCE8042FF15A95745334A2A60C'
