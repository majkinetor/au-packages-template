...
$url = 'https://download.red-gate.com/installers/SQLToolbelt/2020-03-18/SQLToolbelt.exe'
$checksum = 'ADEBBB8E8182C98CC7FF67224A78F9E093DD1B893EC84D9E2E13ADFF9D4EEB8D'
