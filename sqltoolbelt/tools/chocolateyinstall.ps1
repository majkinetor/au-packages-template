...
$url = 'https://download.red-gate.com/installers/SQLToolbelt/2020-06-09/SQLToolbelt.exe'
$checksum = '6580CD7496BD270EB9F34203E24C72018AA9329C419ED3D3EBDC0471434CC55B'
