...
$url = 'https://download.red-gate.com/installers/SQLToolbelt/2019-11-20/SQLToolbelt.exe'
$checksum = 'E5E5DEA91DF857F84CFC5FA0B142193FFD924BBACFDCA241E1EEFA15F447F869'
