...
$url = 'https://download.red-gate.com/installers/SQLToolbelt/2020-02-05/SQLToolbelt.exe'
$checksum = '010ED878CB39BD8ADFD7278A5B01D51CE387631A3201050CDDA30DEFECF83260'
