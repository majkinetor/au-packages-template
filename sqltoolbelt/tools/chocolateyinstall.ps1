...
$url = 'https://download.red-gate.com/installers/SQLToolbelt/2020-06-10/SQLToolbelt.exe'
$checksum = 'CC8B2896691FD6C0E38280C5D0F5B400DC2C972C64F4B5B3AD384827368F196D'
