...
$url = 'https://download.red-gate.com/installers/SQLToolbelt/2019-10-21/SQLToolbelt.exe'
$checksum = '410CB27F12C1CC2165AA9049C2BEE79864331D3C113EEA3E9092C736481A45AE'
