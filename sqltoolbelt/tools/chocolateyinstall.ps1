...
$url = 'https://download.red-gate.com/installers/SQLToolbelt/2020-07-22/SQLToolbelt.exe'
$checksum = 'B8ECBAC337F3297131EFAD85F4A006172EC02BC6FB1F71373AA25F027D9954A7'
