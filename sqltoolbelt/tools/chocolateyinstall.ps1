...
$url = 'https://download.red-gate.com/installers/SQLToolbelt/2019-11-28/SQLToolbelt.exe'
$checksum = '9FA665DEBE8E5ED6CD2E8FBE181173D0B9292CA5FE22C584CABD02DEC7AFE796'
