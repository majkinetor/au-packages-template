...
$url = 'https://download.red-gate.com/installers/SQLToolbelt/2020-07-14/SQLToolbelt.exe'
$checksum = '1B2C52A6CB4B98F307293A98DBC83C698AEE3151627110787EE8EAEC0F3E704D'
