...
$packageName= 'usamimi-hurricane' # arbitrary name for the package, used in messages
$toolsDir   = "$(Split-Path -parent $MyInvocation.MyCommand.Definition)"
$url        = 'http://ftp.vector.co.jp/68/23/2117/UsaMimi_v025.zip' # download url, HTTPS preferred
...
$packageArgs = @{
  ...
  softwareName  = 'UsaMimi Hurricane*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
