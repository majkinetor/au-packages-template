...
function global:au_GetLatest {
	$release = (curl -UseBasicParsing "https://api.github.com/repos/deemru/stunnel/releases/latest?client_id=$env:GITHUB_CLIENT_ID&client_secret=$env:GITHUB_CLIENT_SECRET" | ConvertFrom-Json)
