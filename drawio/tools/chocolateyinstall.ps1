...
$packageArgs = @{
  ...
  url           = $url
  softwareName  = 'drawio*'
  checksum      = '5e5d1ce41cd3844dac872b9fd3852cc3453d0ee9f40ed76044df002231a99dc41b5c07ce89d0183d8b1e2b10ca0917f8f94860de0673ec90608f0a12b04e0b3f'
  checksumType  = 'sha512'
  silentArgs   = '/S'
}
