...
$packageArgs = @{
  ...
  url           = $url
  softwareName  = 'drawio*'
  checksum      = '4b556ca9d6b2510f1e11516cf0eba6c5e3d264e9bb02d873d03d826a0b07e43173bd08250792f94cabf19f396de362c5379f77e8ed5b31d5d3a14155df515c3d'
  checksumType  = 'sha512'
  silentArgs   = '/S'
}
