...
$packageArgs = @{
  ...
  url           = $url
  softwareName  = 'drawio*'
  checksum      = '74a8be808050711e5606219c34104693722104f13c3822488ff0e0c9d2255ffe27f47e86a0cc430444f5b64300e0acbf29b98e3dc0cad11cab61095e1d9383a6'
  checksumType  = 'sha512'
  silentArgs   = '/S'
}
