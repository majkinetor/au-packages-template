...
$packageArgs = @{
  ...
  url           = $url
  softwareName  = 'drawio*'
  checksum      = '3c0143cadba60ea4d9ef152748b7b0e4feca18304e215f6b8d6f5480ef1ec3e244df591e503f9bd15e03308019d233092bc05eba8047f1706544928a3cb7625d'
  checksumType  = 'sha512'
  silentArgs   = '/S'
}
