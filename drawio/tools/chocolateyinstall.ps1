...
$packageArgs = @{
  ...
  url           = $url
  softwareName  = 'drawio*'
  checksum      = '346125e6c79050a515ffaaa70f82935ad9e7f10b21250ff6a2a0bdfd4fed752c34362b48477f99f1523db0f738f0736d2f9d62896c7fa6ebcd8f08f8212adfea'
  checksumType  = 'sha512'
  silentArgs   = '/S'
}
