...
$packageArgs = @{
  ...
  url           = $url
  softwareName  = 'drawio*'
  checksum      = '613c24b2d3721623bdb3fc5cc5397f52837e15497a9fa7b291024a717452bdda140c42db588a09d81756971211d357f33cca5a370c4d3d7f986cf9ecf5676904'
  checksumType  = 'sha512'
  silentArgs   = '/S'
}
