...
$packageName= 'pandoc-crossref' # arbitrary name for the package, used in messages
$toolsDir   = "$(Split-Path -parent $MyInvocation.MyCommand.Definition)"
$url        = 'https://github.com/lierdakil/pandoc-crossref/releases/download/v0.2.5.0/windows-ghc8-pandoc1-19.zip' # download url, HTTPS preferred
...
$packageArgs = @{
  ...
  softwareName  = 'pandoc-crossref*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
